...
description:
  The limits the flight control system enforces, what it will refuse to let
  you do, and who is actually in command
week: 3
date: 2027-03-08
teachers:
  - wren-oyelaran
spec:
  - you can state the G and angle-of-attack limits the system enforces
  - you can describe a manoeuvre the aircraft will decline to perform
  - you can tell a limit you cannot exceed from a restriction you must not
related:
  - lectures/week-03
  - assessments/egress-and-systems
---
...
Most of what kills people in this airframe is in the second category.

## Afterwards

List every restriction in the flight manual that the aircraft would let you
break tomorrow. Bring the list to week 9. It will be shorter than you think
and worse than you expect.
